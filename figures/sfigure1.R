# supplemental figure qc metrics and lineage markers for multiomes
...
plotA <- VlnPlot(multi, features = "nCount_RNA", group.by = "library_id", pt.size = 0) +
 xlab("") +
...
plotB <- VlnPlot(multi, features = "nFeature_RNA", group.by = "library_id", pt.size = 0) +
 xlab("") +
...
plotC <- VlnPlot(multi, features = "nCount_ATAC", group.by = "library_id", pt.size = 0) +
 xlab("") +
 ggtitle("C) nCount_ATAC") +
 theme_bw() +
 theme(plot.title = element_text(face="bold"), 
       legend.pos = "none", 
       axis.text = element_text(color="black"), 
...
plotD <- VlnPlot(multi, features = "nFeature_ATAC", group.by = "library_id", pt.size = 0) +
 xlab("") +
 ggtitle("D) nFeature_ATAC") +
 theme_bw() +
 theme(plot.title = element_text(face="bold"), 
       legend.pos = "none", 
       axis.text = element_text(color="black"), 
...
plotE <- DotPlot(multi, features=marker.genes) + 
 ggtitle("E) RNA Lineage Markers") +
 theme_bw() +
 theme(plot.title = element_text(face="bold"), 
       legend.pos = "none", 
       axis.text = element_text(color="black"), 
...
pdf(here(plots,"sfigure1.pdf"), width = 7.5, height = 10)
